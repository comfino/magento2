...
final class BootstrapTest extends TestCase
{
    ...
    /**
     * App state reporting the frontend area, so init() skips the CETS token claim (which would otherwise resolve an
     * ApiClient through the uninitialized ObjectManager).
     */
